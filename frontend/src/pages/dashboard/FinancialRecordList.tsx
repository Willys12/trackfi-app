...
const EditableCell: React.FC<EditableCellProps> = ({value: initialValue, row, column, updateRecord, editable}) => {
  // Use local state to keep track of the value
  ...
  const columns : Array<Column<FinancialRecord>> = useMemo(() => [
    {
      ...
      Cell: (props) => (
         <EditableCell {...props} updateRecord={updateCell} editable={true}/>
      ),
    },
    {
      Header: "Amount",
    ...
    },
    {
      ...
      accessor: "date",
      Cell: (props) => (
         <EditableCell {...props} updateRecord={updateCell} editable={false}/>
      ),
    },
    {
      Header: "Delete",
